...
| **Academic Headline / Subtitle** | `_pages/about.md` (`subtitle`) & `_data/profile.yml` (`headline`) | E.g. *"BSc in Electrical & Electronic Engineering · Communication & Signal Processing · BUET"*. |
